...
* Bruno CLI
  * provides
    * MULTIPLE command options / 
      * help you customize your API testing & execution process
      * allow you to
...
| Option                        | Details                      |
|-------------------------------|------------------------------|
| `-h`, `--help`                | 's output: usage information |
| `--version`                   | 's output: version number    |

## Setup options

| Option                        | Details                                                                                                            |
|-------------------------------|--------------------------------------------------------------------------------------------------------------------|
| `--env [string]`              | == environment -- to -- run with                                                                                   |
